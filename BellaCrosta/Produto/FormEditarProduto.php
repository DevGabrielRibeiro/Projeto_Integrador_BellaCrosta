                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" id="navbar-color">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            ...
                            <img class="img-profile rounded-circle" src="../image/Avatar.png">
                        </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="p-5">
                                                ...
                                                <form class="user" action="EditarProduto.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputImagem" class="mb-2 font-weight-bold">Imagem do Produto</label>
                                                        <input type="file" class="form-control form-control-user" id="exampleInputImagem" name="imagem" accept="image/*">
                                                        <?php if (!empty($campo["imagem"])): ?>
                                                            <div class="mt-2">
                                                                <img src="../uploads/<?= htmlspecialchars($campo["imagem"]) ?>" alt="Imagem atual" class="img-thumbnail" style="max-width: 150px; max-height: 150px;">
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
